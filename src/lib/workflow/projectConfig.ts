...
export const PRODUCT_NAME = "Compare" as const;
...
export const CHECKLIST_BRIDGE_VERSION = "compare-checklist@v1";
export const CHECKLIST_MISSION_KEY = "compare-hungary-shooting-ops";
