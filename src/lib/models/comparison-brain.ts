...
const compareJobSchema = new Schema(
  {
    ...
    leftEntityId: { type: String, required: true, index: true },
    rightEntityId: { type: String, required: true, index: true },
    leftDomain: { type: String, required: true, index: true },
    rightDomain: { type: String, required: true, index: true },
...
const savedComparisonSchema = new Schema(
  {
    ...
    lastSubmittedAt: { type: Date, default: null, index: true },
    lastSubmittedByHash: { type: String, default: null, index: true },
