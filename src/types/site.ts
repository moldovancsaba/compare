...
export const DEFAULT_SITE: Omit<SiteDoc, "_id"> = {
  ...
  trustPillars: [
    {
      title: "EU by design",
      desc: "EU-focused listings organized by country and region.",
      tone: "orange",
      icon: "compass",
    },
    {
    ...
    {
      title: "GDPR-aware",
      desc: "Built for consent-conscious lead collection and compliant operator outreach.",
      tone: "pink",
      icon: "users",
    },
    {
      title: "Save & compare",
      desc: "Favorite venues and estimate total training or event costs.",
      tone: "blue",
      icon: "calculator",
    },
  ],
