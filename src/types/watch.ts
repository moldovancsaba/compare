...
export interface WatchSpec {
  ...
  lugToLugMm: number;
  lugWidthMm: number;
  caseMaterial?: "steel" | "titanium" | "gold" | "ceramic" | "two-tone";
  bezelType?: "smooth" | "timing" | "count-up" | "fixed-24h" | "rotating-60" | "internal";
  crystal?: "sapphire" | "acrylic" | "mineral";
  ...
  claspType?: string;
  strapOptions?: string[];
  accuracyClaimSecondsPerDay?: string;
  microAdjust: boolean;
  dateWindow: boolean;
  lumeProfile: string;
